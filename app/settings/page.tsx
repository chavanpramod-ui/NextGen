      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1 flex flex-col gap-6">
          ...
          <div className="dashboard-panel p-6 sm:p-8 flex flex-col gap-6">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-4 rounded-xl border border-cyan-500/30 bg-cyan-500/5 dark:bg-cyan-500/10">
              <div>
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">Access the ultra-premium login & SSO portal styled for both Dark and Light themes.</p>
              </div>
              <Link
                href="/login"
                className="shrink-0 rounded-lg bg-gradient-to-r from-violet-600 to-cyan-500 px-4 py-2 text-sm font-semibold text-white shadow-[0_0_15px_rgba(34,211,238,0.3)] hover:scale-105 transition-all"
              >
                Go to Login Portal
              </Link>
            </div>
