    ...
    <div className="mx-auto flex w-full max-w-[1500px] flex-col gap-6 px-4 py-4 sm:px-6 lg:px-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="lg:w-64 shrink-0 flex flex-col gap-2">
          ...
          <button className="flex items-center gap-3 px-4 py-3 text-slate-400 hover:text-slate-200 hover:bg-slate-800/50 rounded-xl font-medium transition-colors text-left">
            <Bell size={18} />
            Notifications
          </button>
          <button className="flex items-center gap-3 px-4 py-3 text-slate-400 hover:text-slate-200 hover:bg-slate-800/50 rounded-xl font-medium transition-colors text-left">
        ...
        <div className="flex-1 flex flex-col gap-6">
          ...
          <div className="dashboard-panel p-6 sm:p-8 flex flex-col gap-6">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-4 rounded-xl border border-slate-700/50 bg-slate-800/30">
              <div>
                ...
                <p className="text-sm text-slate-400 mt-1">We recommend updating your password every 3 months.</p>
              </div>
              <button className="shrink-0 rounded-lg border border-slate-600 bg-slate-800 px-4 py-2 text-sm font-medium text-slate-300 hover:bg-slate-700 hover:text-white transition-colors">
                Update Password
              </button>
            </div>
          </div>
          ...
          <div className="dashboard-panel p-6 sm:p-8 flex flex-col gap-6 border-red-500/20">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-4 rounded-xl border border-red-500/20 bg-red-500/5">
              ...
              <button className="shrink-0 rounded-lg bg-red-500/10 border border-red-500/20 px-4 py-2 text-sm font-medium text-red-400 hover:bg-red-500 hover:text-white transition-colors">
                Delete Account
              </button>
            </div>
          </div>
