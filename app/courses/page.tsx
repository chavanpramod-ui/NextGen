  ...
  return (
    <div className="mx-auto flex w-full max-w-[1500px] flex-col gap-6 px-4 py-4 sm:px-6 lg:px-8">
      ...
      <div className="dashboard-panel p-8 text-center flex flex-col items-center justify-center min-h-[400px]">
        ...
        <h2 className="text-xl font-semibold text-slate-200">Courses section under development</h2>
        <p className="text-slate-400 mt-2 max-w-md">We are currently building this section. Soon you will be able to browse all available modules and tracks here.</p>
      </div>
    </div>
  );
}
