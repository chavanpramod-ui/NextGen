                ...
                <ul className="flex max-h-48 flex-col overflow-y-auto">
                  {recentSearches.map((term, i) => (
                    <li key={i}>
                      <button
                        type="button"
                        className="group flex w-full items-center gap-3 rounded-lg px-3 py-2 text-left text-sm text-slate-700 transition-all duration-300 hover:scale-[1.02] hover:bg-gradient-to-r hover:from-cyan-500/10 hover:to-violet-500/10 hover:text-cyan-700 hover:shadow-md dark:text-slate-300 dark:hover:from-cyan-500/20 dark:hover:to-violet-500/20 dark:hover:text-cyan-300"
                        onClick={() => {
                          setSearchQuery(term);
